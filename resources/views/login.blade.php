...
<form class="col-4  offset-4 border rounded" methot="POST" action="{{ route('login_process') }}">
    @csrf 
    ...
    <div>
        <a href="{{route('forgot')}}" class="offset-1 font-mediun text-blue-900 hover:bg-blue-300 rounded-md p-2">Forgot password?</a>      
    </div>
    <div>
        <a href="{{route('registration')}}" class="offset-1 font-mediun text-blue-900 hover:bg-blue-300 rounded-md p-2">Sign up</a>      
    </div>
    <div>
