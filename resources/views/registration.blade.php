...
<form action="{{ route('registration_process')}}" class="col-3 offset-4 border rounded " methot="POST" >
    @csrf
    ...
    <div>
        <a href="{{route('login')}}" class="offset-1 font-mediun text-blue-900 hover:bg-blue-300 rounded-md p-2">Log in</a>      
    </div>
    <div>
