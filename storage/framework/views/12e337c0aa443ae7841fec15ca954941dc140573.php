                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                        <div class="container mx-auto px-6 py-8">
                            <h3 class="text-gray-700 text-3xl font-medium">Add new</h3>
                            ...
                            <div class="mt-8">
                                <form enctype="multipart/form-data" class="space-y-5 mt-5" method=POST" action"<?php echo e(route("admin.posts.store")); ?>"">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\OpenServer\domains\diplom\resources\views/admin/create.blade.php ENDPATH**/ ?>